...
namespace EnglishNow.Services
{
    public interface ITurmaService
    {
        ...
        IList<TurmaResult> ListarPorProfessorId(int professorId);
    ...
    public class TurmaService : ITurmaService
    {
        ...
        public CriarTurmaResult Criar(CriarTurmaRequest request)
        {
            ...
            //inserir a turma
            var turmaId = _turmaRepository.Inserir(request.MapToTurma());
        ...
        public ExcluirTurmaResult Excluir(int id)
        {
            ...
            if (turma == null)
            {
                result.MensagemErro = "Não foi possível encontrar a turma";
        ...
        public IList<TurmaResult> ListarPorProfessorId(int professorId)
        {
            var turmas = _turmaRepository.ListarPorProfessorId(professorId);
